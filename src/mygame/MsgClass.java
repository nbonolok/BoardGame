  	...
  	public void setLangDialog(String lang)
	{
	    //set to english
            if(lang == null ? "EN" == null : lang.equals("EN"))
		   {
     	 	...
     	 	langTitleGE=" Bokhutlo jwa Motshameko ";//" Bokhutl� jwa Motshameko ";
                langTitleCM="Tshameka Dikgomo mo sakeng";
                langTitleRM="Kgomo e ka Kgarakgatsega";//"Kgomo e ka Kgarakgats�ga";
     	 	langPlayer=" Modisa ";
     	 	langCow=" Kgomo ";
     	 	 ...
     	 	 langDrawGameMsg=" Puo pedi sakeng,Ga gona mofenye.";//" P�� pedi sakeng,Ga gona mofenye.";
